...
struct JNIEnv_ {
	...
	jobject CallStaticObjectMethod(jclass clazz, jmethodID methodID, ...) {
		...
		jobject result;
		va_start(args, methodID);
		result = functions->CallStaticObjectMethodV(this, clazz, methodID,
				args);
		va_end(args);
		return result;
	}
	...
	jboolean CallStaticBooleanMethod(jclass clazz, jmethodID methodID, ...) {
		...
		jboolean result;
		va_start(args, methodID);
		result = functions->CallStaticBooleanMethodV(this, clazz, methodID,
				args);
		va_end(args);
		return result;
	}
	...
	jdouble CallStaticDoubleMethod(jclass clazz, jmethodID methodID, ...) {
		...
		jdouble result;
		va_start(args, methodID);
		result = functions->CallStaticDoubleMethodV(this, clazz, methodID,
				args);
		va_end(args);
		return result;
	}
