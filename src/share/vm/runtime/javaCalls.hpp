...
#ifndef SHARE_VM_RUNTIME_JAVACALLS_HPP_
#define SHARE_VM_RUNTIME_JAVACALLS_HPP_
...
public:
	...
	JavaCallWrapper(methodHandle callee_method, Handle receiver, JavaValue* resutl, TRAPS);
	~JavaCallWrapper();
...
#endif /* SHARE_VM_RUNTIME_JAVACALLS_HPP_ */
