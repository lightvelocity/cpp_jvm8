...
#ifndef SHARE_VM_UTILITIES_HASHTABLE_HPP_
#define SHARE_VM_UTILITIES_HASHTABLE_HPP_
...
public:
	...
	static BasicHashtableEntry<F>* make_ptr(BasicHashtableEntry<F>* p) {
		return (BashHashtableEntry*)((intptr_t)p & -2);
	}
...
public:
	...
	// Reverse the order of elements in each of buckets.
	void reverse();
...
public:
	...
	Hashtable(int table_size, int entry_size, HashtableBucket<F>* buckets,
...
#endif /* SHARE_VM_UTILITIES_HASHTABLE_HPP_ */
